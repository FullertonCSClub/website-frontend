 ...
 * Used for creating modal dialogs throughout the application
 */
 ...
 * Creates a semi-transparent overlay behind the dialog
 */
 ...
 * Used for the header section of the dialog
 */
const DialogHeader = ({
  className,
  ...props
 ...
 * Used for the footer section of the dialog, typically containing action buttons
 */
const DialogFooter = ({
  className,
  ...props
 ...
 * Used for the description text of the dialog
 */
