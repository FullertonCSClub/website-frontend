...
/**
 * Dropdown menu component based on Radix UI Dropdown Menu primitive
 * Used for creating dropdown menus throughout the application
 */
const DropdownMenu = DropdownMenuPrimitive.Root;

/**
 * Dropdown menu trigger component
 * Used to trigger the opening of a dropdown menu
 */
const DropdownMenuTrigger = DropdownMenuPrimitive.Trigger;

/**
 * Dropdown menu group component
 * Used to group related dropdown menu items
 */
const DropdownMenuGroup = DropdownMenuPrimitive.Group;

/**
 * Dropdown menu portal component
 * Renders the dropdown menu content in a portal
 */
const DropdownMenuPortal = DropdownMenuPrimitive.Portal;

/**
 * Dropdown menu sub component
 * Used to create nested dropdown menus
 */
const DropdownMenuSub = DropdownMenuPrimitive.Sub;

/**
 * Dropdown menu radio group component
 * Used to create a group of radio items in a dropdown menu
 */
const DropdownMenuRadioGroup = DropdownMenuPrimitive.RadioGroup;

/**
 * Dropdown menu sub trigger component
 * Used to trigger the opening of a nested dropdown menu
 */
 ...
 * Contains the content of a nested dropdown menu
 */
 ...
 * Contains the main content of the dropdown menu
 */
 ...
 * Used for individual items in a dropdown menu
 */
 ...
 * Used for checkbox items in a dropdown menu
 */
 ...
 * Used for radio items in a dropdown menu
 */
 ...
 * Used for labels in a dropdown menu
 */
 ...
 * Used to separate groups of items in a dropdown menu
 */
 ...
 * Used to display keyboard shortcuts in dropdown menu items
 */
